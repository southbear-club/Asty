...
#ifndef PROTOBUF_INCLUDED_http_5fserver_2eproto
#define PROTOBUF_INCLUDED_http_5fserver_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_http_5fserver_2eproto 
...
namespace google {
namespace protobuf {
template<> ::asty::op_http_srv::HttpRequest* Arena::CreateMaybeMessage<::asty::op_http_srv::HttpRequest>(Arena*);
template<> ::asty::op_http_srv::HttpResponse* Arena::CreateMaybeMessage<::asty::op_http_srv::HttpResponse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace asty {
namespace op_http_srv {
...
class HttpRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:asty.op_http_srv.HttpRequest) */ {
 public:
  HttpRequest();
  virtual ~HttpRequest();
  ...
  // @@protoc_insertion_point(class_scope:asty.op_http_srv.HttpRequest)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::internal::HasBits<1> _has_bits_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_http_5fserver_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class HttpResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:asty.op_http_srv.HttpResponse) */ {
 public:
  HttpResponse();
  ...
  // @@protoc_insertion_point(class_scope:asty.op_http_srv.HttpResponse)
 private:
...
class HttpService : public ::google::protobuf::Service {
 ...
 public:
  ...
  virtual void open_api(::google::protobuf::RpcController* controller,
                       const ::asty::op_http_srv::HttpRequest* request,
                       ::asty::op_http_srv::HttpResponse* response,
                       ::google::protobuf::Closure* done);
  virtual void admin_api(::google::protobuf::RpcController* controller,
                       const ::asty::op_http_srv::HttpRequest* request,
                       ::asty::op_http_srv::HttpResponse* response,
                       ::google::protobuf::Closure* done);
...
class HttpService_Stub : public HttpService {
 public:
  ...
  void open_api(::google::protobuf::RpcController* controller,
                       const ::asty::op_http_srv::HttpRequest* request,
                       ::asty::op_http_srv::HttpResponse* response,
                       ::google::protobuf::Closure* done);
  void admin_api(::google::protobuf::RpcController* controller,
                       const ::asty::op_http_srv::HttpRequest* request,
                       ::asty::op_http_srv::HttpResponse* response,
                       ::google::protobuf::Closure* done);
 private:
...
#endif  // PROTOBUF_INCLUDED_http_5fserver_2eproto
